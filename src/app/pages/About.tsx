...
const leaders = [
  ...
  fullBio: [
    "Ar. Aditya Kashikar is ARCHORA's SME and Lead Healthcare Advisory Consultant, bringing over 18 years of healthcare capital planning and infrastructure programme leadership from the UK's National Health Service to the Indian market. An architect by initial training with an MSc in Construction Management, Development Economics and International Development from the University of Greenwich, he is also an NEC3/4 Accredited Project Manager and a Member of both the Association for Project Management and the Association of Construction Quality Professionals.",
    "He has worked within a leading technical management consultancy environment, delivering projects across public sector government frameworks. As Associate Director at WSP, one of the world's leading engineering and professional services firms, his portfolio has spanned new-build inpatient facilities, a COVID-19 Lighthouse Testing Laboratory, pathology service centralisation, and ward remodelling and bed capacity programmes, including work with Imperial College Healthcare, Barts Health, Sussex Partnership, Northwest Anglia Hospitals, and St George's University Hospitals, plus a secondment to the Palace of Westminster Restoration and Renewal Programme.",
